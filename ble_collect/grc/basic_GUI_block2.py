...
# Title: Basic Gui Block2
# Generated: Tue Jun 12 13:27:58 2018
##################################################
...
class basic_GUI_block2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Basic Gui Block2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic Gui Block2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "basic_GUI_block2")
...
def main(top_block_cls=basic_GUI_block2, options=None):
