...
# Title: File Transfer
# Generated: Mon Aug 20 11:23:21 2018
##################################################
...
class file_transfer(gr.top_block):
    ...
    def __init__(self):
        ...
        self.file_source = blocks.file_source(gr.sizeof_gr_complex*1, '/Users/mmohamoud/software_defined_radios/data_files/demodulated_file_data', True)
        ...
        self.blocks_message_sink_0 = blocks.message_sink(gr.sizeof_char*1, self.message_queue, False)
...
def main(top_block_cls=file_transfer, options=None):
