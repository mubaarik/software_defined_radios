...
# Title: Basic Gui Block
# Generated: Tue Jun 12 12:47:15 2018
##################################################
...
class basic_GUI_block(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Basic Gui Block")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic Gui Block")
        ...
        self.settings = Qt.QSettings("GNU Radio", "basic_GUI_block")
        ...
        # Connections
        ##################################################
        self.connect((self.analog_simple_squelch, 0), (self.qtgui_time_sink_x_0, 0))
...
def main(top_block_cls=basic_GUI_block, options=None):
