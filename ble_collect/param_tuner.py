...
class ComparisonData:
  ...
  def __init__(self):
    ...
    self.gfsk_omega_limit = GR_Parameter(0.035,.002,.001,.009)
...
def print_settings(gr, opts):
  ...
  print ' %-22s: %ss' % ('Scanning Window', '{:.2f}'.format(opts.ble_scand_window))
...
INPUT_FILE = "tuning_files_rm/input_file"
HOPE_TIME = 40;
